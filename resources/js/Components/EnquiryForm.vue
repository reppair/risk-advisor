...
<template>
    <form @submit.prevent="submit">
        ...
        <div class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-6">
            <TextInput v-model="name" name="name" label="Name" placeholder="Martin Blagoev" class="sm:col-span-4" />
            <TextInput v-model="email" name="email" label="Email" placeholder="mb.reppair@gmail.com" class="sm:col-span-4" />
            <TextInput v-model="phone" name="phone" label="Phone" placeholder="+359 894 390 903" class="sm:col-span-4" />
            <TextInput v-model="address" name="address" label="Address" placeholder="Sofia, Bulgaria, 1000" class="sm:col-span-4" />
